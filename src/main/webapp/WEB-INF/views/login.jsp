                        ...
                        <div class="card-body p-0">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane active p-3" id="LogIn_Tab" role="tabpanel">
                                    <form id="formSubmit" class="form-horizontal auth-form" method="post">
                                        ...
                                        <div class="form-group mb-2">
                                            ...
                                            <div class="input-group">
                                                <input type="password" class="form-control" placeholder="Enter password" name="password" id="password-field">
                                            </div>
                                        </div><!--end form-group-->
                                        ...
                                        <div class="form-group row my-3">
                                            ...
                                            <div class="col-sm-6 text-end">
                                                <a class="text-muted font-13"><i class="dripicons-lock"></i> Forgot password?</a>
                                            </div><!--end col-->
                                        </div><!--end form-group-->

                                        <div class="form-group mb-0 row">
                                            <div class="col-12">
                                                <button class="btn btn-primary w-100 waves-effect waves-light" type="button" id="btnLogin">Log In <i class="fas fa-sign-in-alt ms-1"></i></button>
                                            </div><!--end col-->
                                        </div> <!--end form-group-->
                                    </form><!--end form-->
    ...
    $('#btnLogin').click(function (e) {
        ...
        $.ajax({
            ...
            success: function (result) {
                if(result.role.code == 'ADMIN'){
                    console.log("ADMIN")
                    window.location.href = "/admin/product-list";
                }
                else window.location.href = "/customer/order";
            },
